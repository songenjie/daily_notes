...
- 15、兼容Spring原生配置：兼容Spring原生配置方式 “[@Value](https://github.com/Value)”、”${}” 加载本地配置功能；与分布式配置获取方式隔离，互不干扰；
...
![img](https://cdn.jsdelivr.net/gh/hivefans/mypic/2020/07/27/b91681.png)