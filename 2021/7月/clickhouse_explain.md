# EXPLAIN Statement[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain)
...
## EXPLAIN Types[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain-types)
...
### EXPLAIN AST[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain-ast)
...
### EXPLAIN SYNTAX[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain-syntax)
...
### EXPLAIN PLAN[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain-plan)
...
- `indexes` — Shows used indexes, the number of filtered parts and the number of filtered granules for every index applied. Default: 0. Supported for [MergeTree](https://clickhouse.tech/docs/en/engines/table-engines/mergetree-family/mergetree/) tables.
- `actions` — Prints detailed information about step actions. Default: 0.
- `json` — Prints query plan steps as a row in [JSON](https://clickhouse.tech/docs/en/interfaces/formats/#json) format. Default: 0. It is recommended to use [TSVRaw](https://clickhouse.tech/docs/en/interfaces/formats/#tabseparatedraw) format to avoid unnecessary escaping.
...
### EXPLAIN PIPELINE[ ](https://clickhouse.tech/docs/en/sql-reference/statements/explain/#explain-pipeline)
...
[Оriginal article](https://clickhouse.tech/docs/en/sql-reference/statements/explain/)